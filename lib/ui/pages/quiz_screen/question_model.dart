...
class Question {
  ...
  Question({required this.questionText, required this.answersList, required this.tags, required this.more});

  factory Question.fromJson(Map<String, dynamic> json) {
    return Question(
      questionText: json['questionText'],
      answersList: List<Answer>.from(json['answersList'].map((answer) => Answer.fromJson(answer))),
      tags: json['tags'],
      more: json['more'],
    );
  }
...
List<Question> getQuestions() {
  List<Question> list = [
    Question(
      questionText: "Hành tinh nào gần nhất với Mặt Trời?",
      answersList: [
        Answer(answerText: "Trái Đất", isCorrect: false),
        Answer(answerText: "Sao Hoả", isCorrect: false),
        Answer(answerText: "Sao Mộc", isCorrect: false),
        Answer(answerText: "Sao Thủy", isCorrect: true),
      ],
      tags: "Câu trả lời đúng là Sao Thủy đây là hành tinh gần Mặt Trời nhất và là hành tinh nhỏ nhất trong Hệ Mặt Trời (0,055 lần khối lượng Trái Đất).",
      more: "saothuy",
    ),
    Question(
      ...
      answersList: [
        Answer(answerText: "Trái Đất", isCorrect: false),
        Answer(answerText: "Sao Mộc", isCorrect: true),
        Answer(answerText: "Sao Thổ", isCorrect: false),
        Answer(answerText: "Sao Thiên Vương", isCorrect: false),
      ],
      tags: "Câu trả lời đúng là Sao Mộc Hành tinh thứ 5 trong Hệ Mặt trời - Jupiter, Sao Mộc chính là một thế giới khí khổng lồ. Đây là hành tinh lớn nhất trong Thái Dương hệ của chúng ta. ",
      more: "saomoc",
    ),
